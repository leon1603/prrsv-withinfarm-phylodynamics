...
# Classify Infections By Clade - Unstructured

```{r}
# --- Clade Based Infection Classification - Unstructured ---
cat("--- Inferring clade and infection status based on the unstructured tree---\n")
...
# Define the log files to be processed for WGS
...
# Define the log files to be processed for Sample From Prior Analysis
...
# Define the directory for the output results files for ORF5
beast_results_dir_ORF5_BDSKY <- "results/logs/BDSKY_ORF5"

# Define the directory for the output results files for WGS
beast_results_dir_WGS_BDSKY <- "results/logs/BDSKY_WGS"

# Define the directory for the output results files for SampleFromPrior
beast_results_dir_SampleFromPrior_BDSKY <- "results/logs/BDSKY_SampleFromPrior"

# Execute the summary function for ORF5
...
# Execute the summary function for WGS
summarize_beast_logs(
...
# Execute the summary function for SampleFromPrior
summarize_beast_logs(
...
cat("--- Succesfully summarised the log files ---\n\n")
```
...
beast_log_files_to_process_ORF5_BDMM <- c(
  ...
  "models/BDMM/BDMM_ORF5_ContinuousMigration/BDMM_ORF5_Isolated_ContinuousMigration.log",
  "models/BDMM/BDMM_ORF5_DiscreteMigration_SampleFromPrior/BDMM_ORF5_DiscreteMigration_SampleFromPrior.log",
  "models/BDMM/BDMM_ORF5_ContinuousMigration_SampleFromPrior/BDMM_ORF5_ContinuousMigration_SampleFromPrior.log"
  )

# Define the *full path* for the output results file for ORF5
beast_results_dir_ORF5_BDMM <- "results/logs/BDMM_ORF5"
...
BDMM_files <- c(
  "results/logs/BDMM_ORF5/BDMM_ORF5_DiscreteMigration.tsv",
  "results/logs/BDMM_ORF5/BDMM_ORF5_DiscreteMigration_SampleFromPrior.tsv",
  "results/logs/BDMM_ORF5/BDMM_ORF5_Isolated_ContinuousMigration.tsv",
  "results/logs/BDMM_ORF5/BDMM_ORF5_ContinuousMigration_SampleFromPrior.tsv"
)
